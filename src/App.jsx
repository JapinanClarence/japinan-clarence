    ...
    <div className="bg-neutral-950">
      <header className=" h-[50px] w-full top-0 left-0 fixed z-50 bg-black/30 backdrop-blur-md shadow-md">
        ...
        <Sheet>
          ...
          <SheetContent className="w-[400px] sm:w-[540px] bg-black/30 backdrop-blur-md text-white"  aria-describedby={undefined}>
            <SheetHeader>
      ...
      <TracingBeam >
        <div className="relative">
          <div
            className="md:h-[60rem] flex flex-col md:flex-row justify-between items-center"
            id="home"
          >
            <div>
              <h1 className="relative z-10 text-10xl md:text-7xl  bg-clip-text text-transparent bg-gradient-to-b from-neutral-200 to-neutral-600  text-start font-sans font-bold">
                JapinanClarence
              </h1>
