        ...
        <div className="space-y-10">
          <div className="text-white px-10 md:px-0 py-20" id="about">
            ...
            <p className="text-pretty">
              ...
              student with a strong passion for backend web development. I have
              experience working with PHP, MySQL, and the MERN stack and am
              proficient in building scalable and efficient RESTful APIs.
              Constantly eager to learn and improve, I enjoy optimizing database
              structures, enhancing system performance, and developing secure,
          ...
          <div className="text-white px-10 md:px-0 py-20" id="projects">
            <h1 className="text-center text-4xl font-medium mb-5">Projects</h1>
